...
let newDouble = 3.4 + Double(thisInt)
/*: Question 3
...
func average_f (a: Int, b: Int, c: Int) -> Float {
    ...
    let floatAverage = (a + b + c) / 3
    
    return Float(floatAverage)
